...
class StringTest < Minitest::Homework
  ...
  def test_check_if_all_caps
    ...
    assert_equal "ABC", "ABC".upcase
    assert_equal "Hæ?", "Hæ?".upcase
    assert_equal "1, 2, 3", "1, 2, 3".upcase
  end

  def test_if_all_lowercase
    assert_equal "abc", "abc".downcase
    assert_equal "abc", "ABC".downcase
    assert_equal "Æsj!", "Æsj!".downcase
    assert_equal "1, 2, 3", "1, 2, 3".downcase
  end

  def test_upper_and_lower_case
    refute_equal "abc".downcase, "abc".upcase
  ...
  def test_square_brackets
    ...
    assert_equal "mu", "music"[0,2] # starting from 0, give me 2 characters
    assert_equal "si", "music"[2,2] # starting from 2, give me 2 characters
